...
export default function AboutPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      <h1 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-2">📦 About CH Store</h1>

      <p className="text-center text-gray-600 max-w-3xl mx-auto">
        CH Store is your trusted destination for high-quality tech and mobile accessories — from watches to smart gadgets.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            CH Store was founded by <strong>Ch Arham</strong> in 2025 — a passionate new businessman 
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            Our mission is to grow CH Store into a trusted name in the tech accessories space — 
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            At CH Store, we believe in valuable pricing — not overpricing. That’s why we keep our 
      ...
      <div className="text-center mt-6">
        <p className="text-gray-500">
          Thank you for trusting CH Store. We’re here to serve you — honestly, affordably, and with care.
        </p>
      </div>
    </div>
  );
