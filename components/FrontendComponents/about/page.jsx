...
export default function AboutPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      <h1 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-2">📦 About A Store</h1>

      <p className="text-center text-gray-600 max-w-3xl mx-auto">
        A Store is your trusted destination for high-quality tech and mobile accessories — from watches to smart gadgets.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            A Store was founded by <strong>Ch Arham</strong> in 2025 — a passionate new businessman 
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            Our mission is to grow A Store into a trusted name in the tech accessories space — 
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700">
            At A Store, we believe in valuable pricing — not overpricing. That’s why we keep our 
      ...
      <div className="text-center mt-6">
        <p className="text-gray-500">
          Thank you for trusting A Store. We’re here to serve you — honestly, affordably, and with care.
        </p>
      </div>
    </div>
  );
