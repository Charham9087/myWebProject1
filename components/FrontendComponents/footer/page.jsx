  ...
  return (
    <footer className="bg-black text-gray-300 pt-8 pb-4 mt-5">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Brand Info */}
        <div>
          <h5 className="text-lg font-semibold text-white">A Store</h5>
        ...
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li>
              <Link href="/catalogs" className="hover:text-white transition-colors">Catalogs</Link>
            </li>
            <li>
      ...
      <p className="text-center text-sm text-gray-500">
        &copy; {new Date().getFullYear()} A Store. All rights reserved.
      </p>
    </footer>
  );
}
